...
public class Game {
	...
	static void startGame() {
		JFrame frame = new JFrame("Empire Building");
		...
		frame.getContentPane().setBackground(Color.ORANGE);
		{
			...
			enterName.setFont(new Font("", Font.BOLD, 36));
			JPanel name = new JPanel(new FlowLayout());
			name.add(enterName);
			name.add(playerName);
			frame.add(name);
			JLabel choice = new JLabel("Please choose the city with which you want to start.");
			...
			cairo.addActionListener(new Starter(frame, playerName, "Cairo"));
			sparta.addActionListener(new Starter(frame, playerName, "Sparta"));
			rome.addActionListener(new Starter(frame, playerName, "Rome"));
			JPanel cities = new JPanel();
			cities.setLayout(new GridLayout(1, 0));
			cities.add(cairo); cities.add(rome); cities.add(sparta);
			frame.add(name);
			choice.setHorizontalAlignment(0);
			choice.setFont(new Font("", Font.BOLD, 50));
			frame.add(choice);
			frame.add(cities);
		}
